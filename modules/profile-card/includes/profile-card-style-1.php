...
<div class="profile-card-style-1 fl-node-<?php echo esc_attr($id); ?>" style="background-image:url(<?php if ($settings->profile_bg_image == '') { echo esc_url(CEBB_URL . 'assets/images/default.png'); } else { echo esc_url($settings->profile_bg_image_src); } ?>);">
    <div class=" column column-block">
        <div class="team-member">
            <div class="team-member-profile">
                ...
                <?php } else { ?>
                    <img src="<?php echo esc_url($settings->profile_image_src); ?>" class="img img-responsive">
                <?php } ?>
            </div>
            ...
            <div class="team-member__socialmedia">
                ...
                foreach ( $settings->profile_icons as $icon ) {
                    ...
                    if ( ! empty( $icon->connections->link ) && empty( $icon->link ) ) {
                        ...
                        echo '<a class="beaver-icon beaver-social-icon '. esc_attr($classes[0]) .' beaver-social-icon-' . esc_attr( $icon_count ) . '" href="' . esc_url($icon->link) . '" target="' . esc_attr( $icon->link_target ) . '">'; 
...
<style> 
.profile-card-style-1.fl-node-<?php echo esc_attr($id); ?> .team-member__socialmedia .beaver-icon i,.profile-card-style-1.fl-node-<?php echo esc_attr($id); ?> .team-member__socialmedia .beaver-icon i:before{ 
    /* Icon Color */
...
.profile-card-style-1.fl-node-<?php echo esc_attr($id); ?> .team-member__socialmedia .beaver-icon i:hover,
.profile-card-style-1.fl-node-<?php echo esc_attr($id); ?> .team-member__socialmedia .beaver-icon i:hover:before {
...
.profile-card-style-1.fl-node-<?php echo esc_attr($id); ?> .beaver-icon:not(:last-child){
