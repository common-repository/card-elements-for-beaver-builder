...
<div class="profile-card-style-4 fl-node-<?php echo esc_attr($id); ?>" style="background-image:url(<?php if ($settings->profile_bg_image == '') { echo esc_url(CEBB_URL . 'assets/images/default.png'); } else { echo esc_url($settings->profile_bg_image_src); } ?>);">
    <?php if ($settings->profile_image == '') { ?>
        <img src="<?php echo esc_url(CEBB_URL . 'assets/images/default.png'); ?>" class="img img-responsive"/>
    <?php } else { ?>
        <img src="<?php echo esc_attr($settings->profile_image_src); ?>" class="img img-responsive">
    <?php } ?>    
...
<style>
.profile-card-style-4.fl-node-<?php echo esc_attr($id); ?> .team-member__socialmedia .beaver-icon i,.profile-card-style-2.fl-node-<?php echo esc_attr($id); ?> .team-member__socialmedia .beaver-icon i:before{ 
    /* Icon Color */
...
.profile-card-style-4.fl-node-<?php echo esc_attr($id); ?> .team-member__socialmedia .beaver-icon i:hover,
.profile-card-style-4.fl-node-<?php echo esc_attr($id); ?> .team-member__socialmedia .beaver-icon i:hover:before {
...
.profile-card-style-4.fl-node-<?php echo esc_attr($id); ?> .beaver-icon:not(:last-child){
